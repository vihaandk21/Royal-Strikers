...
# Replace the basic .cards layout with an asymmetric editorial luxury layout
luxury_layout = '''
...
html = re.sub(r'<div class="cards">.*?</div>\s*</div>\s*</section>', luxury_layout + '\n      </section>', html, flags=re.DOTALL)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(html)
print("Updated index.html to luxury asymmetric layout")
